...
const loadingGifs = [loading1, loading2, loading3, loading4, loading5, loading6, loading7, loading8, loading9, loading10, loading11, loading12, loading13, loading14, loading15, loading16, loading17, loading18, loading19, loading20]
...
function LoadingModal({isFetching}) {
  ...
  const handleUpdateGif = () => setGifIndex( Math.floor(Math.random() * loadingGifs.length ))
    ...
    <Dialog open={isFetching}>
      ...
      <DialogContent>
        <Typography variant="body1" gutterBottom>
          Enjoy our selection of MTG gifs while you wait
        </Typography>
        <img onClick={handleUpdateGif} src={loadingGifs[gifIndex]} alt="gif" width="250px" />
      </DialogContent>
