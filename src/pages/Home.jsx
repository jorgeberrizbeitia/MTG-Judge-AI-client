        ...
        <CardContent>
          ...
          <List dense>
            <ListItem>
              ...
              <ListItemText primary="Ask any MTG related question from rules, abilities or card interactions" />
            </ListItem>

            <ListItem>
              <img src={blackMana} alt="mana-logo" style={{width: "25px", margin: "5px"}}/>
              <ListItemText primary="Be as precise and clear with your question as possible" />
            </ListItem>
